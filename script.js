...
const I18N = {
  en: {
    ...
    "rev.count":"Based on 25 reviews on Google","rev.src":"Google review","rev.all":"Read all reviews on Google",
    "rev.r1":"“Fast and good service, without deposit I rented a car, thank you!”",
    "rev.r2":"“Excellent company! The car was in perfect condition, everything clean and in good working order. The service was excellent — pickup, registration and return were quick and hassle-free.”",
    "rev.r3":"“We rented a 7-seater car for a reasonable price and were very satisfied. Highly recommend! 👍”",
  ...
  ru: {
    ...
    "rev.count":"На основе 25 отзывов в Google","rev.src":"Отзыв в Google","rev.all":"Все отзывы в Google",
    "rev.r1":"“Быстрый и хороший сервис, взял авто без залога, спасибо!”",
    "rev.r2":"“Отличная компания! Машина в идеальном состоянии, всё чистое и исправное. Отличный сервис — подача, оформление и возврат быстро и без хлопот.”",
    "rev.r3":"“Взяли 7-местную машину по адекватной цене, остались очень довольны. Рекомендую! 👍”",
